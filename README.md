...
Никакой задачи нет, просто общее изучение потоков в c++ на базе [статьи](https://rekovalev.site/multithreading-3-cpp/)

Ещё полезное [чтиво](https://habr.com/ru/articles/182610/).
